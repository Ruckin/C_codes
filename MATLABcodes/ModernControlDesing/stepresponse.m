...
% OF A LINEAR TIME-INVARIANT DYNAMICAL SYSTEM TO A FINETE STEP INPUT.
%
...
function [y, t] = stepresponse(num, den, t0, dt, tfinal)

% FIND A PARTIAL FRACTION EXPANSION OF num/den CONSIDERING A POLE IN THE
% ORIGIN
